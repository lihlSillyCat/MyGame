...
namespace War.Scene
{
    ...
    public class InfiniteOcean : MonoBehaviour
    {
        ...
        protected int ot_WaveScales ;
        protected int ot_WaveLengths;
        protected int ot_WaveExponents;
        protected int ot_WaveOffsets;
        protected int ot_WaveDirection01;
        protected int ot_WaveDirection23;
        protected int ot_WaveConstants;
        protected int ot_WaveDerivativeConstants;
        protected int ot_WorldMove;

        protected int ot_NormalMap0;
        protected int ot_NormalMap1;
        protected int ot_FoamMap;

        protected int ot_LightDir;
        protected int ot_DeepWaterColorUnlit;
        protected int ot_DeepWaterIntensityZenith;
        protected int ot_DeepWaterIntensityHorizon;
        protected int ot_DeepWaterIntensityDark;
        protected int ot_DeepWaterColor;

        protected int ot_Proj;
        protected int ot_InvView;

        protected int ot_ViewCorner0;
        protected int ot_ViewCorner1;
        protected int ot_ViewCorner2;
        protected int ot_ViewCorner3;

        protected int ot_OceanPosition;
        ...
        {
            ot_WaveScales = Shader.PropertyToID("ot_WaveScales");
            ot_WaveLengths = Shader.PropertyToID("ot_WaveLengths");
            ot_WaveExponents = Shader.PropertyToID("ot_WaveExponents");
            ot_WaveOffsets = Shader.PropertyToID("ot_WaveOffsets");
            ot_WaveDirection01 = Shader.PropertyToID("ot_WaveDirection01");
            ot_WaveDirection23 = Shader.PropertyToID("ot_WaveDirection23");
            ot_WaveConstants = Shader.PropertyToID("ot_WaveConstants");
            ot_WaveDerivativeConstants = Shader.PropertyToID("ot_WaveDerivativeConstants");
            ot_WorldMove = Shader.PropertyToID("ot_WorldMove");

            ot_NormalMap0 = Shader.PropertyToID("ot_NormalMap0");
            ot_NormalMap1 = Shader.PropertyToID("ot_NormalMap1");
            ot_FoamMap = Shader.PropertyToID("ot_FoamMap");

            ot_LightDir = Shader.PropertyToID("ot_LightDir");
            ot_DeepWaterColorUnlit = Shader.PropertyToID("ot_DeepWaterColorUnlit");
            ot_DeepWaterIntensityZenith = Shader.PropertyToID("ot_DeepWaterIntensityZenith");
            ot_DeepWaterIntensityHorizon = Shader.PropertyToID("ot_DeepWaterIntensityHorizon");
            ot_DeepWaterIntensityDark = Shader.PropertyToID("ot_DeepWaterIntensityDark");
            ot_DeepWaterColor = Shader.PropertyToID("ot_DeepWaterColor");

            ot_Proj = Shader.PropertyToID("ot_Proj");
            ot_InvView = Shader.PropertyToID("ot_InvView");

            ot_ViewCorner0 = Shader.PropertyToID("ot_ViewCorner0");
            ot_ViewCorner1 = Shader.PropertyToID("ot_ViewCorner1");
            ot_ViewCorner2 = Shader.PropertyToID("ot_ViewCorner2");
            ot_ViewCorner3 = Shader.PropertyToID("ot_ViewCorner3");

            ot_OceanPosition = Shader.PropertyToID("ot_OceanPosition");   
        }
        ...
        protected void PreRender(Camera cam)
        {
            ...
            float oldcamnear = cam.nearClipPlane;
            ...
            if (points.Count > 0)
            {
                ...
                //Vector3 viewFrameZ = cam.transform.forward;// Vector3.Normalize(focus - camPos);
                ...
                //Matrix4x4 proj = Matrix4x4.Perspective(cam.fieldOfView, cam.aspect, cam.nearClipPlane + 0.3f, cam.farClipPlane);
