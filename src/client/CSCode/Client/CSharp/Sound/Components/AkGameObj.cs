...
public class AkGameObj : MonoBehaviour
{
	...
	public Vector3 GetPosition()
	{
		if (m_positionOffsetData != null)
		{
			...
			return War.Scene.StreamerManager.GetRealPosition(transform.position) + worldOffset;
		}

		return War.Scene.StreamerManager.GetRealPosition(transform.position);
	}
...
#pragma warning restore 0414 // private field assigned but not used.
	...
	private class Migration14Data
	{
		...
		public Migration14Data()
		{
			...
			var listenerObjects = AkAudioListener.sAkAudioListenerList;
