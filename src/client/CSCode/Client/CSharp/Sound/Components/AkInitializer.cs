...
public class AkInitializer : MonoBehaviour
{
    ...
    public static System.Collections.Generic.Dictionary<uint, string> derivedTypes = new System.Collections.Generic.Dictionary<uint, string>();
    public static void GetAllDerivedTypes()
    {
        if (derivedTypes.Count == 0)
        {
            derivedTypes.Add(AkShortIDGenerator.Compute("AkTriggerEnter"), "AkTriggerEnter");
            derivedTypes.Add(AkShortIDGenerator.Compute("AkTriggerExit"), "AkTriggerExit");
            //Add the Awake, Start and Destroy triggers and build the displayed list.
            derivedTypes.Add(AkShortIDGenerator.Compute("Awake"), "Awake");
            derivedTypes.Add(AkShortIDGenerator.Compute("Start"), "Start");
            derivedTypes.Add(AkShortIDGenerator.Compute("Destroy"), "Destroy");
            derivedTypes.Add(AkShortIDGenerator.Compute("Enable"), "Enable");
            derivedTypes.Add(AkShortIDGenerator.Compute("Disable"), "Disable");
            derivedTypes.Add(AkShortIDGenerator.Compute("TriggerEnter"), "TriggerEnter");
            derivedTypes.Add(AkShortIDGenerator.Compute("TriggerExit"), "TriggerExit");
        }
    }
